...
[CustomEditor(typeof(DynamicLightsLevelData))]
public class DynamicLightsLevelDataEditor : Editor
{
    ...
    public bool usev2;
    DynamicLightsLevelData lightmapData;
    ...
    {
        lightmapData = target as DynamicLightsLevelData;
